...
//const ExcursionCon = React.createContext();
// export function exportContextProvide() {
//   <ExcursionCon.Provider value={savedObject}></ExcursionCon.Provider>;
// }
export var excursionForExport;
export var excursionIDForExport;
...
function CreateExcursion(props) {
  ...
  async function SaveExcursion(e) {
    ...
    const ExcursionObj = Parse.Object.extend("Excursion");
    excursionIDForExport = awa;
  }

  /*
  export function savedExc() {
    return savedObject;
  }
  */
